       ...
       <section className='max-w-5xl mt-0 flex-col mx-auto'>
        <nav className="py-4 flex justify-between">
          ...
          <div className="flex gap-3">
           <Link href="/dashbord/"> <Button className="border-solid bg-black text-white rounded-full px-6 py-2 font-semibold transition duration-300 ease hover:scale-[1.1] hover:bg-opacity-95">Get Started</Button></Link>
